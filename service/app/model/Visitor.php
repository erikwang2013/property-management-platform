...
class Visitor extends BaseModel
{
    ...
    protected $fillable = ['id', 'room_id', 'owner_id', 'visitor_name', 'visitor_phone', 'visitor_id_card', 'plate_number', 'visitor_count', 'purpose', 'expected_start', 'expected_end', 'actual_start', 'actual_end', 'pass_code', 'status'];
    protected $casts = [
