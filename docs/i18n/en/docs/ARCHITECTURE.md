...
> The Mermaid diagrams below render automatically on GitHub / GitLab / VS Code. In other environments, use the [Mermaid Live Editor](https://mermaid.live/) to view them.
...
## 4. Authentication Flow (with Click Captcha)
...
## 8. Database ER Relationships (Batch 1)
...
## 10. Security Defense-in-Depth Overview
