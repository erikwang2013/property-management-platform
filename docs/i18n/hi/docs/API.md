...
- Key प्रबंधन: `php scripts/gen_api_key.php [--name=उपयोग]` से जनरेट करें; अक्षम/हटाना सीधे `management_api_key` टेबल पर कार्य (`status=0` अर्थात अक्षम, कुंजी तुरंत अमान्य)
