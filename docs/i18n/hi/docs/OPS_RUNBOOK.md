...
admin एंड और service एंड समान MySQL इंस्टेंस और डेटाबेस `property_management` साझा करते हैं, एक बार बैकअप पर्याप्त है। एकीकृत प्रवेश:

| डेटाबेस नाम | बैकअप स्क्रिप्ट | विवरण |
|---|---|---|
| `property_management` | `scripts/backup.sh` | `admin/.env` से कनेक्शन पढ़ता है (`--container=` से कंटेनर नाम ओवरराइड कर सकते हैं), डिफ़ॉल्ट कंटेनर के भीतर mysqldump |
...
3. सत्यापन:
   - पंक्ति संख्या तुलना: `SELECT COUNT(*) FROM erik_user;` बैकअप से पहले के रिकॉर्ड से मेल खाती है
