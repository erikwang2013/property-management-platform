...
**Сяочжу** (小筑) — талисман проекта: очеловеченный управляющий домом со светящимися окнами. Он появляется в мастере установки, на страницах ошибок, на странице входа и на схеме архитектуры.
...
<img src="../../images/design_architecture_en.svg" alt="Общая архитектура системы" width="1000">

### Обзор функциональных модулей

<img src="../../images/design_function_en.svg" alt="Обзор функциональных модулей" width="1000">

### Жизненный цикл сущностей данных

<img src="../../images/design_lifecycle_en.svg" alt="Жизненный цикл сущностей данных" width="1000">
