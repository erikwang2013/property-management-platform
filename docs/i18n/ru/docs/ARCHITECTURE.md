# Документ архитектуры (Architecture)

> Copyright (c) 2026 erik <erik@erik.xyz> — https://erik.xyz

> Следующие диаграммы Mermaid автоматически отображаются в GitHub / GitLab / VS Code. В других средах используйте [Mermaid Live Editor](https://mermaid.live/).
...
## 4. Процесс аутентификации (с кликовой капчей)
...
## 7. Многослойное шифрование данных
...
## 8. ER-отношения базы данных (партия 1)
...
## 10. Обзор эшелонированной защиты
