...
admin পাশ ও service পাশ একই MySQL ইনস্ট্যান্স ও ডেটাবেস `property_management` শেয়ার করে, একবার ব্যাকআপ করলেই হয়। ইউনিফাইড এন্ট্রি:

| ডেটাবেস নাম | ব্যাকআপ স্ক্রিপ্ট | ব্যাখ্যা |
|---|---|---|
| `property_management` | `scripts/backup.sh` | `admin/.env` থেকে কানেকশন পড়ে (`--container=` দিয়ে কন্টেইনার নাম ওভাররাইড করা যায়), ডিফল্ট কন্টেইনারে mysqldump |
...
3. যাচাই:
   - সারি সংখ্যা তুলনা: `SELECT COUNT(*) FROM erik_user;` ব্যাকআপের আগের রেকর্ডের সাথে মিলে
