# আর্কিটেকচার ডকুমেন্ট (Architecture)

> Copyright (c) 2026 erik <erik@erik.xyz> — https://erik.xyz

> নিচের Mermaid চার্ট GitHub / GitLab / VS Code-এ স্বয়ংক্রিয়ভাবে রেন্ডার হয়। অন্যান্য পরিবেশে [Mermaid Live Editor](https://mermaid.live/) দিয়ে দেখুন।
...
## 2. ব্যাকএন্ড লেয়ার্ড আর্কিটেকচার
...
## 4. প্রমাণীকরণ প্রক্রিয়া (ক্লিক ক্যাপচাসহ)
...
## 10. নিরাপত্তা গভীর প্রতিরক্ষা প্যানোরামা
