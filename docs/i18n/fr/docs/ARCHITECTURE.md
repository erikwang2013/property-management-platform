# Document d'architecture (Architecture)

> Copyright (c) 2026 erik <erik@erik.xyz> — https://erik.xyz

> Les diagrammes Mermaid ci-dessous se rendent automatiquement dans GitHub / GitLab / VS Code. Dans les autres environnements, utilisez le [Mermaid Live Editor](https://mermaid.live/).

---

## 1. Architecture topologique du système
...
## 4. Processus d'authentification (avec captcha cliquable)
...
## 8. Relations ER de la base de données (lot 1)
...
## 10. Vue d'ensemble de la défense en profondeur
