...
## 2. Arquitetura em camadas do back-end
...
## 4. Fluxo de autenticação (com código de verificação por clique)
...
## 8. Relacionamento ER do banco de dados (1ª fase)
...
## 10. Panorama da defesa em profundidade de segurança
