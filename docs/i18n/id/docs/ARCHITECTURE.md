...
> Diagram Mermaid berikut dapat dirender otomatis di GitHub / GitLab / VS Code. Lingkungan lain gunakan [Mermaid Live Editor](https://mermaid.live/) untuk melihat.
...
## 4. Alur Autentikasi (termasuk captcha klik)
...
## 8. Hubungan ER Database (Batch 1)
...
## 10. Panorama Pertahanan Berlapis Keamanan
