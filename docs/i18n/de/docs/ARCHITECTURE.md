# Architekturdokument (Architecture)

> Copyright (c) 2026 erik <erik@erik.xyz> — https://erik.xyz

> Die folgenden Mermaid-Diagramme werden in GitHub / GitLab / VS Code automatisch gerendert. Für andere Umgebungen verwenden Sie bitte den [Mermaid Live Editor](https://mermaid.live/).
...
## 4. Authentifizierungsablauf (mit Klick-Captcha)
...
## 7. Datenverschlüsselung nach Ebenen
...
## 8. Datenbank-ER-Beziehungen (1. Charge)
...
## 10. Gesamtübersicht der Verteidigung in der Tiefe
