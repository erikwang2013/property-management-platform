...
|----|------|------|
| Datenbanktabellen | 65 | Alle mit `erik_`-Präfix, BIGINT-Primärschlüssel ohne Auto-Inkrement |
...
- **Sprache**: PHP 8.3+
- **Datenbank**: MySQL 8.0+, Tabellenpräfix `erik_`, BIGINT-Primärschlüssel ohne Auto-Inkrement
