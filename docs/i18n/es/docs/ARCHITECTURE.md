# Documento de Arquitectura (Architecture)

> Copyright (c) 2026 erik <erik@erik.xyz> — https://erik.xyz

> Los siguientes diagramas Mermaid se renderizan automáticamente en GitHub / GitLab / VS Code. En otros entornos use [Mermaid Live Editor](https://mermaid.live/).
...
## 4. Flujo de autenticación (con código de verificación de clic)
...
## 8. Relaciones ER de la base de datos (Lote 1)
...
## 10. Panorama de defensa en profundidad de seguridad
