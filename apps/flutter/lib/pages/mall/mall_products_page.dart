          ...
          child: _loading
              ...
              : GridView.builder(
                  ...
                  itemBuilder: (_, i) {
                    ...
                    return Card(
                      child: InkWell(
                        onTap: () => Get.toNamed('/mall-product-detail', arguments: p),
                        child: Padding(
                          padding: const EdgeInsets.all(16),
                          child: Column(
                            ...
                            children: [
                              ...
                              const Spacer(),
                              Row(children: [
                                Text('¥${p['price'] ?? '-'}', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.red)),
                                const Spacer(),
                                Text('库存:${p['stock'] ?? 0}', style: const TextStyle(fontSize: 11, color: Colors.grey)),
                              ]),
                            ],
                          ),
                        ),
