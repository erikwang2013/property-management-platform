...
-- 迁移: 物业管理系统 — 第2批 辅助域（10 张）
-- 拆分规则: 停车/设备/投诉/访客/合同/财务 6 模块
--   (parking_space/parking_vehicle/parking_record/equipment/
--    equipment_maintenance/complaint/visitor/contract/
--    finance_income/finance_expense)
-- 依赖: 批1 基础域（owner/room/community 等引用表均在其后创建，
--   外键均为普通索引，无 FK 约束）
