...
class GreenAreaController extends BaseCrudController {
  final areas = <Map<String, dynamic>>[].obs;
  @override String get basePath => ApiConfig.greenArea;
...
class GreenMaintenanceController extends GetxController {
  ...
  Future<void> loadItems({bool reset = false}) async {
    ...
    try {
      final r = await api.get(ApiConfig.greenMaintenance, params: {'page': page.value, 'limit': 15});
