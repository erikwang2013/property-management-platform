...
| admin 控制器 | 47个 | 通用管理 + 22个物业模块 + 12个扩展功能 |
| service 控制器 | 17个 | 业主端全部 API |
| API 路由 | 178+ | admin 123+ + service 55+ |
| Flutter 管理后台 | 57页 | admin 34模块全覆盖，96文件/6,462行 |
| Flutter 业主端 | 23页 | 费用/报修/停车/访客/活动/通知/投票/商城/智能问答/人脸，32文件/3,148行 |
| HarmonyOS | 7页 | 登录/首页/账单/报修(2)/公告/个人中心，10文件/831行 |
| 测试 | 133个 | admin 90个(196断言) + service 43个(83断言) |
